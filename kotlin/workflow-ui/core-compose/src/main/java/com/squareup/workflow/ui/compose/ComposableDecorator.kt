...
interface ComposableDecorator {
  ...
  @Composable fun decorate(children: @Composable() () -> Unit)
...
fun ComposableDecorator(
  ...
  @Composable override fun decorate(children: @Composable() () -> Unit) = decorator(children)
}
...
internal class AssertingComposableDecorator(
  ...
  @Composable override fun decorate(children: @Composable() () -> Unit) {
...
private object NoopComposableDecorator : ComposableDecorator {
  @Composable override fun decorate(children: () -> Unit) {
    children()
  }
}
